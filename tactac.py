...
parser.add_argument('--binning', nargs='?', default='all', \
    help='Split library into equally sized bins. Expects an input (fasta files) directory or an "all" flag which will distribute all accessions registered in the accessions table.')
